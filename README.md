...
To build the final jar and optimize the StudentManagement application for production, run:
...
Then navigate to [http://localhost:8087](http://localhost:8087) in your browser.
